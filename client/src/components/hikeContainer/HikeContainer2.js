...
handleClick = event => {
  ...
  render() {
    ...
    <div className="card-body">
        ...
        {/* <button onClick={this.handleClick(event, this.state.result.trails[1].id)}>Click Me!</button> */}


        <span className="save-btn btn" role="button"
        onClick={this.handleClick}
        >Save Hike<input type="hidden" name="hike" value={this.state.result.trails[1].id} /></span>
